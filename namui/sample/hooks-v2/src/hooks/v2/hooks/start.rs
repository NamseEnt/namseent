...
//     let done = render(component_instance.clone(), component);

//     // let children = match done {
//     //     RenderDone::WithEvent {
//     //         event_context,
//     //         on_event,
//     //         render,
//     //     } => {
//     //         let child = mount_visit(render(event_context.as_ref()).as_ref());
//     //         vec![child]
//     //     }
//     //     RenderDone::WithoutEvent { render } => {
//     //         let child = mount_visit(render().as_ref());
//     //         vec![child]
//     //     }
//     //     RenderDone::RenderingTree { rendering_tree } => vec![],
//     // };
...
//     // let done = component.get().unwrap().render(&context);

//     // let children = match done {
//     //     RenderDone::Rendered { child } => vec![mount_visit(child.into())],
//     //     RenderDone::NoRender => vec![],
//     // };
