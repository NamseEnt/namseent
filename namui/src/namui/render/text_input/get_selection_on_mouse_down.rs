use super::Props;
use crate::namui::{self, get_text_width_internal, managers, TextInput};
use std::ops::Range;
...
impl TextInput {
    pub(crate) fn get_selection_on_mouse_down(
        ...
        let aligned_x = match props.text_param.align {
            ...
            namui::TextAlign::Center => click_x - (props.text_param.x),
            namui::TextAlign::Right => text_width - (props.text_param.x - click_x),
        };
