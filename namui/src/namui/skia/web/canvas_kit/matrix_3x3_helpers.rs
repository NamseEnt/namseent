...
extern "C" {
    ...
    // #[wasm_bindgen(method)]
    // pub(crate) fn identity(this: &Matrix3x3Helpers) -> Box<[f32]>;

    ///
    ///Returns the inverse of the given 3x3 matrix or null if it is not invertible.
    ///@param m
    #[wasm_bindgen(method)]
    pub(crate) fn invert(this: &Matrix3x3Helpers, matrix: &[f32]) -> Box<[f32]>;
    ...
    // #[wasm_bindgen(method)]
    // pub(crate) fn mapPoints(this: &Matrix3x3Helpers,m: Matrix3x3 | [f32], points: [f32]) -> Box<[f32]>;

    // ///
    // ///Multiplies the provided 3x3 matrices together from left to right.
    // ///@param matrices
    // #[wasm_bindgen(method)]
    // pub(crate) fn multiply(this: &Matrix3x3Helpers,...matrices: Array<(Matrix3x3 | [f32])>) -> Box<[f32]>;
    ...
    // #[wasm_bindgen(method)]
    // pub(crate) fn rotated(this: &Matrix3x3Helpers,radians: AngleInRadians, px?: number, py?: number) -> Box<[f32]>;
    ...
    // #[wasm_bindgen(method)]
    // pub(crate) fn scaled(this: &Matrix3x3Helpers,sx: number, sy: number, px?: number, py?: number) -> Box<[f32]>;
    ...
    // #[wasm_bindgen(method)]
    // pub(crate) fn skewed(this: &Matrix3x3Helpers,kx: number, ky: number, px?: number, py?: number) -> Box<[f32]>;
    ...
    // ///@param dy
    // #[wasm_bindgen(method)]
    // pub(crate) fn translated(this: &Matrix3x3Helpers,dx: number, dy: number) -> Box<[f32]>;
