...
extern "C" {
    ...
    // ///
    // #[wasm_bindgen(method)]
    // pub(crate) fn makeShaderWithChildren(this: &CanvasKitRuntimeEffect, uniforms: Float32Array | number[], isOpaque?: boolean,
    //                     children: Option<[CanvasKitShader]>, localMatrix?: InputMatrix): CanvasKitShader;
}
