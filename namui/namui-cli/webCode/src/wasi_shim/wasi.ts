    ...
    constructor(
        ...
        this.wasiImport = {
            ...
            fd_filestat_set_times(
                ...
                if (self.fds[fd] != undefined) {
                    return self.fds[fd].fd_filestat_set_times(
                        atim,
                        mtim,
                        fst_flags,
                    );
            ...
            fd_pread(
                ...
                if (self.fds[fd] != undefined) {
                    ...
                    for (const iovec of iovecs) {
                        const { ret, data } = self.fds[fd].fd_pread(
                            iovec.buf_len,
                            offset,
                        );
            ...
            fd_prestat_dir_name(
                ...
                if (self.fds[fd] != undefined) {
                    console.log("here");
                    const { ret, prestat } = self.fds[fd].fd_prestat_get();
                    console.log("fd_prestat_get", ret, prestat);
                    if (prestat == null) {
                        console.log("prestat", prestat);
                        return ret;
                    }
                    const prestat_dir_name = prestat.inner.pr_name;
                    console.log("prestat_dir_name", prestat_dir_name);
            ...
            fd_pwrite(
                ...
                if (self.fds[fd] != undefined) {
                    ...
                    let nwritten = 0;
                    for (const iovec of iovecs) {
                        const data = buffer8.slice(
                            iovec.buf,
                            iovec.buf + iovec.buf_len,
                        );
                        const { ret, nwritten: nwritten_part } = self.fds[
                            fd
            ...
            fd_read(
                ...
                if (self.fds[fd] != undefined) {
                    ...
                    let nread = 0;
                    for (const iovec of iovecs) {
                        const { ret, data } = self.fds[fd].fd_read(
                            iovec.buf_len,
                        );
                        if (ret != wasi.ERRNO_SUCCESS) {
                            buffer.setUint32(nread_ptr, nread, true);
            ...
            fd_readdir(
                ...
                if (self.fds[fd] != undefined) {
                    ...
                    while (true) {
                        ...
                        const head_bytes = new ArrayBuffer(
                            dirent.head_length(),
                        );
            ...
            path_filestat_get(
                ...
                if (self.fds[fd] != undefined) {
                    ...
                    const { ret, filestat } = self.fds[fd].path_filestat_get(
                        flags,
                        path,
                    );
                    if (filestat != null) {
            ...
            path_link(
                ...
                const buffer8 = new Uint8Array(self.inst.exports.memory.buffer);
                if (
                    self.fds[old_fd] != undefined &&
                    self.fds[new_fd] != undefined
                ) {
            ...
            random_get(buf: number, buf_len: number) {
                ...
                if (
                    ...
                    !(
                        self.inst.exports.memory.buffer instanceof
                        SharedArrayBuffer
                    )
                ) {
