	...
	await db.insert(User).values([
		{
			...
			name: '남세현',
			email: 'skatpgusskat@gmail.com',
			image: 'https://lh3.googleusercontent.com/a/ACg8ocLECBKWz3jXxlRFO8SGPoGHkPaLfOOCNhr-1afTPYVDcz9rpFGW=s96-c',
		},
		{
			id: 'test@example.com',
			name: '테스트 사용자',
	...
	await db.insert(Funding).values([
		{
			...
			contentImage: 'https://images.unsplash.com/photo-1551782450-17144efb9c50?w=800&h=1200&fit=crop',
			currentTickets: 15,
			targetTickets: 30,
		},
		{
			...
			contentImage: 'https://images.unsplash.com/photo-1559339352-11d035aa65de?w=800&h=1200&fit=crop',
			currentTickets: 8,
			targetTickets: 20,
		},
		{
			...
			contentImage: 'https://images.unsplash.com/photo-1558030006-450675393462?w=800&h=1200&fit=crop',
			currentTickets: 22,
			targetTickets: 25,
		},
		{
			...
			contentImage: 'https://images.unsplash.com/photo-1617093727343-374698b1b08d?w=800&h=1200&fit=crop',
			currentTickets: 3,
			targetTickets: 15,
		},
		{
			...
			contentImage: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=800&h=1200&fit=crop',
			currentTickets: 12,
			targetTickets: 18,
		},
		{
			...
			contentImage: 'https://images.unsplash.com/photo-1551218808-94e220e084d2?w=800&h=1200&fit=crop',
			currentTickets: 5,
			targetTickets: 50,
		}
	]);
