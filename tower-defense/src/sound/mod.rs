...
pub use asset::{
    ...
    random_fail, random_flamethrower, random_knife_slash, random_level_up, random_luggage_drop,
    random_murchunga, random_orch_hit, random_paper_crumpling, random_pick_up_cards,
    random_pickaxe, random_red_laser_shot, random_shining_ringing, random_smoke_bomb,
    random_trumpet_fanfares, random_whoop, random_whoosh, random_wind,
};
