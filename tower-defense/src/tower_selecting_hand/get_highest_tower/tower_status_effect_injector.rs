...
use crate::game_state::upgrade::{TowerSelectUpgradeTarget, TowerUpgradeState};
use crate::game_state::GameState;

pub fn inject_status_effects(tower: &mut TowerTemplate, game_state: &GameState) {
    ...
    } else if game_state.rerolled_count > 0 {
        for _ in 0..game_state.rerolled_count {
            if let Some(upgrade) = game_state
                .upgrade_state
                .tower_select_upgrade_states
