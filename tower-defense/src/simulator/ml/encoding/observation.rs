...
use crate::simulator::environment::{HandItemObservation, Observation};
use crate::simulator::ml::vocabulary::{engraving_key_id, rank_id, suit_id};
...
fn card_row(card: &crate::simulator::environment::CardObservation) -> EntityRow {
    EntityRow::new(
        [
            suit_id(&card.suit) as u32,
            rank_id(&card.rank) as u32,
...
fn tower_row(tower: &crate::simulator::environment::TowerTemplateObservation) -> EntityRow {
    EntityRow::new(
        [
