...
use crate::simulator::environment::{LegalAction, Observation};
...
pub struct DiagnosticStep {
    pub decision_point: crate::simulator::environment::DecisionPoint,
    ...
    pub reward: crate::simulator::environment::RewardComponents,
    pub terminated: bool,
    pub truncated: bool,
}
...
pub struct DiagnosticTrace {
    ...
    pub termination_reason: crate::simulator::environment::StepReason,
...
pub fn collect_diagnostic_trace(
    ...
    let episode = crate::simulator::policy_runner::run_episode(
        config,
        seed,
        &crate::simulator::policy_runner::PolicyRunnerConfig {
