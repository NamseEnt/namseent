...
use crate::simulator::policy_runner::{ScriptedOracleTrace, run_scripted_oracle_with_stage_limit};
...
struct ResolvedRunManifest {
    ...
    mode: String,
    reward_config: crate::simulator::environment::RewardConfig,
...
fn train_command_once(options: TrainCommandOptions) -> Result<()> {
    ...
    let reward_config = crate::simulator::environment::RewardConfig {
        no_progress_cycle_penalty,
        damage_progress_weight,
        ..crate::simulator::environment::RewardConfig::default()
    };
    reward_config.validate().map_err(anyhow::Error::msg)?;
...
mod diagnostic_trace_tests {
    use super::*;
    use crate::simulator::environment::{DecisionPoint, RewardComponents, StepReason};
    use crate::simulator::ml::rollout::DiagnosticTrace;
    use crate::simulator::policy_runner::ScriptedOracleStep;
...
fn overfit_gate_command(
    ...
    let scripted_trajectory = crate::simulator::policy_runner::run_scripted_oracle_trajectory(
        Arc::clone(&game_config),
        0,
    )?;
...
mod run_manifest_tests {
    ...
    fn test_manifest(
        ...
        emit_training_startup(
            mode,
            &crate::simulator::environment::RewardConfig {
    ...
    fn canonical_best_promotion_rejects_a_different_reward_objective() {
        let current = crate::simulator::environment::RewardConfig {
            no_progress_cycle_penalty: -0.25,
            ..Default::default()
        };
        let existing = crate::simulator::environment::RewardConfig {
