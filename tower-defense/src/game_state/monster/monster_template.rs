...
impl MonsterTemplate {
    ...
    pub fn new(kind: MonsterKind) -> Self {
        let (max_hp, velocity, damage, reward, skills) = match kind {
            MonsterKind::Mob01 => (20.0, 1.0, 1.0, 3, vec![]),
            MonsterKind::Mob02 => (30.0, 1.0, 1.0, 3, vec![]),
            MonsterKind::Mob03 => (65.0, 1.0, 1.0, 3, vec![]),
            MonsterKind::Mob04 => (90.0, 1.0, 1.0, 3, vec![]),
            MonsterKind::Mob05 => (130.0, 1.0, 1.0, 3, vec![]),
            MonsterKind::Mob06 => (135.0, 1.0, 1.0, 5, vec![]),
            MonsterKind::Mob07 => (145.0, 1.0, 1.0, 5, vec![]),
            MonsterKind::Mob08 => (155.0, 1.0, 1.0, 5, vec![]),
            MonsterKind::Mob09 => (260.0, 1.0, 1.0, 5, vec![]),
            MonsterKind::Mob10 => (360.0, 1.0, 1.0, 5, vec![]),
            MonsterKind::Mob11 => (380.0, 1.0, 1.0, 5, vec![]),
            MonsterKind::Mob12 => (420.0, 1.0, 1.0, 5, vec![]),
            MonsterKind::Mob13 => (430.0, 1.0, 1.0, 5, vec![]),
            MonsterKind::Mob14 => (700.0, 1.0, 1.0, 5, vec![]),
            MonsterKind::Mob15 => (2750.0, 1.0, 1.0, 5, vec![]),
            MonsterKind::Mob16 => (2800.0, 1.0, 1.0, 5, vec![]),
            MonsterKind::Mob17 => (2900.0, 1.0, 1.0, 5, vec![]),
            MonsterKind::Mob18 => (3000.0, 1.0, 1.0, 5, vec![]),
