...
impl MonsterTemplate {
    ...
    pub fn new(kind: MonsterKind) -> Self {
        let (max_hp, velocity, damage, reward, skills) = match kind {
            ...
            MonsterKind::Mob05 => (250.0, 1.0, 1.0, 3, vec![]),
            MonsterKind::Mob06 => (850.0, 0.75, 1.0, 5, vec![]),
            MonsterKind::Mob07 => (1750.0, 0.75, 1.0, 5, vec![]),
            MonsterKind::Mob08 => (6000.0, 0.4, 1.0, 5, vec![]),
            MonsterKind::Mob09 => (3500.0, 1.25, 1.0, 5, vec![]),
            MonsterKind::Mob10 => (7500.0, 0.75, 1.0, 5, vec![]),
            MonsterKind::Mob11 => (10000.0, 1.0, 1.0, 5, vec![]),
            MonsterKind::Mob12 => (15000.0, 1.0, 1.0, 5, vec![]),
            MonsterKind::Mob13 => (45000.0, 0.5, 1.0, 5, vec![]),
            MonsterKind::Mob14 => (20000.0, 1.5, 1.0, 5, vec![]),
            MonsterKind::Mob15 => (45000.0, 1.0, 1.0, 5, vec![]),
            MonsterKind::Named01 => (100.0, 0.5, 3.0, 30, vec![]),
            MonsterKind::Named02 => (500.0, 0.75, 3.0, 30, vec![]),
            MonsterKind::Named03 => (1500.0, 1.0, 3.0, 30, vec![]),
            MonsterKind::Named04 => (3500.0, 1.25, 3.0, 30, vec![]),
            MonsterKind::Named05 => (15000.0, 0.5, 5.0, 30, vec![]),
            MonsterKind::Named06 => (30000.0, 0.75, 5.0, 30, vec![]),
            MonsterKind::Named07 => (45000.0, 1.0, 5.0, 30, vec![]),
            MonsterKind::Named08 => (65000.0, 1.25, 5.0, 30, vec![]),
            MonsterKind::Named09 => (200000.0, 0.5, 7.0, 30, vec![]),
            MonsterKind::Named10 => (250000.0, 0.75, 7.0, 30, vec![]),
            MonsterKind::Named11 => (300000.0, 1.0, 7.0, 30, vec![]),
            MonsterKind::Named12 => (300000.0, 1.25, 7.0, 30, vec![]),
            MonsterKind::Named13 => (650000.0, 0.5, 10.0, 30, vec![]),
            MonsterKind::Named14 => (550000.0, 0.75, 10.0, 30, vec![]),
            MonsterKind::Named15 => (550000.0, 1.0, 10.0, 30, vec![]),
            MonsterKind::Named16 => (750000.0, 1.25, 10.0, 30, vec![]),
