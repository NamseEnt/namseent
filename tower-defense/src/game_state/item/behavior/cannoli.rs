...
impl CannoliItem {
    ...
    pub fn standard() -> Self {
        Self::new(crate::Health::from_integer(9))
    }
...
impl ItemBehavior for CannoliItem {
    ...
    fn thumbnail_source(&self) -> crate::thumbnail::ThumbnailSource<'_> {
        crate::thumbnail::ThumbnailSource::Image(crate::asset::image::thumbnail::CANNOLI)
    }
}
...
mod tests {
    ...
    fn using_cannoli_heals_nine_health() {
        ...
        game_state.hp = max_hp.saturating_sub(crate::Health::from_integer(12));
