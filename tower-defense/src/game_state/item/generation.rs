...
use crate::game_state::{
    ...
    item::{
        GrantCardItem, ItemDiscriminants, LumpSugarItem, MilkItem, RiceBallItem, RubberConeItem,
        ShieldItem,
    },
};
...
fn generate_item_from_discriminant<R: Rng + ?Sized>(item: ItemDiscriminants, rng: &mut R) -> Item {
    match item {
        ...
        ItemDiscriminants::Milk => MilkItem::standard().into_item(),
