...
impl CardServiceBehavior for SpinningTopCardService {
    ...
    fn thumbnail(&self, wh: Wh<Px>, stroke_px: Px, shadow: bool) -> RenderingTree {
        crate::thumbnail::render_sticker_image_with_shadow(
            crate::asset::image::thumbnail::SPINNING_TOP,
            wh,
            stroke_px,
            shadow,
        )
...
mod tests {
    ...
    #[test]
    fn spinning_top_selection_only_engraves_the_selected_card() {
        ...
        SpinningTopCardService.select_cards(&mut game_state, vec![vec![selected]]);
