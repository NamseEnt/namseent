    ...
    T: From<f32> + Into<f32>,
{
    ...
    if displacement_magnitude_sq < SNAP_THRESHOLD * SNAP_THRESHOLD {
        ...
        if velocity_magnitude_sq < VELOCITY_THRESHOLD * VELOCITY_THRESHOLD {
    ...
    let damping_force = context.velocity * (-DAMPING);
