...
pub struct GameState {
    ...
    pub laser_beams: Vec<attack::laser::LaserBeam>,
    pub tower_emit_effects: Vec<attack::instant_effect::TowerEmitEffect>,
    pub target_hit_effects: Vec<attack::instant_effect::TargetHitEffect>,
...
fn create_initial_game_state() -> GameState {
    let mut game_state = GameState {
        ...
        laser_beams: Default::default(),
        tower_emit_effects: Default::default(),
        target_hit_effects: Default::default(),
        items: vec![
            Item {
...
impl GameState {
    ...
    pub fn clone_for_debug(&self) -> GameState {
        GameState {
            ...
            laser_beams: self.laser_beams.clone(),
            tower_emit_effects: self.tower_emit_effects.clone(),
            target_hit_effects: self.target_hit_effects.clone(),
