...
pub(crate) struct CookieItemState {
    pub heal_raw: i64,
}
...
impl ItemBehavior for Behavior {
    fn kind(&self) -> crate::ItemKind {
        crate::ItemKind::Cookie
    }
    fn rarity(&self) -> crate::Rarity {
        crate::Rarity::Common
    }
    fn generated_state(&self) -> ItemRuntimeState {
        ItemRuntimeState::Cookie(CookieItemState { heal_raw: 5_000 })
    }
    ...
    fn apply_use(
        ...
        let ItemRuntimeState::Cookie(state) = state else {
