...
pub(crate) struct CannoliItemState {
    pub heal_raw: i64,
}
...
impl ItemBehavior for Behavior {
    fn kind(&self) -> crate::ItemKind {
        crate::ItemKind::Cannoli
    }
    fn rarity(&self) -> crate::Rarity {
        crate::Rarity::Rare
    }
    fn generated_state(&self) -> ItemRuntimeState {
        ItemRuntimeState::Cannoli(CannoliItemState { heal_raw: 9_000 })
    }
    ...
    fn apply_use(
        ...
        let ItemRuntimeState::Cannoli(state) = state else {
