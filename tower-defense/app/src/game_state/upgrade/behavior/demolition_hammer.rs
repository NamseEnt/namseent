...
impl UpgradePresentation for DemolitionHammerUpgrade {
...
mod tests {
    ...
    fn demolition_hammer_grants_rerolls_used_by_removed_tower() {
        ...
        let tower_id = game_state
            ...
            .id();
        assert!(game_state.apply_compatibility_action(
            crate::game_state::CompatibilityAction::RemoveTower(tower_id)
        ));
