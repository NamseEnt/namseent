...
impl UpgradePresentation for HamburgerUpgrade {
    fn key(&self) -> &'static str {
        "hamburger"
    }

    fn thumbnail_source(&self) -> crate::thumbnail::ThumbnailSource<'_> {
        crate::thumbnail::ThumbnailSource::Image(crate::asset::image::thumbnail::HAMBURGER)
    }
    ...
    fn l10n_description<'a>(
        ...
        match locale.language {
            crate::l10n::locale::Language::English => builder
                ...
                .with_bold(format!("{:.0}", HAMBURGER_MAX_HP_DECREASE))
                .static_text(", ")
                .with_bold("Health")
                .static_text(" recovered by ")
                .with_bold(format!("{:.0}", HAMBURGER_HEAL_AMOUNT))
                .static_text("."),
