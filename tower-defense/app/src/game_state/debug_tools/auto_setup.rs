            ...
            Button::new(
                ...
                &|| {
                    mutate_game_state(|gs| {
                        ...
                        gs.apply_compatibility_action(crate::game_state::CompatibilityAction::StartPlacingTower(template));
                        ...
                        gs.apply_compatibility_action(crate::game_state::CompatibilityAction::Upgrade(upgrade, None));
