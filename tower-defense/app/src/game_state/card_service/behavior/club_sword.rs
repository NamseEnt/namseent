...
impl CardServiceBehavior for ClubSwordCardService {
    ...
    fn thumbnail_source(&self) -> crate::thumbnail::ThumbnailSource<'_> {
        crate::thumbnail::ThumbnailSource::Image(crate::asset::image::thumbnail::CLUB_SWORD)
    }
...
fn generate_club_sword_card_service() -> CardService {
    ClubSwordCardService::new(crate::FixedRatio::from_integer(2)).into_card_service()
}
