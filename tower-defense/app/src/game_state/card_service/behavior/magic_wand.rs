    ...
    fn acquire_selection_steps(
        ...
        vec![
            crate::game_state::modal::deck::CardSelectionStep {
                title: match locale.language {
                    crate::l10n::locale::Language::English => {
                        "Select an engraved card whose engraving will be moved"
                    }
                    crate::l10n::locale::Language::Korean => "옮길 각인이 있는 카드를 선택하세요",
                }
                .to_string(),
                count: 1,
    ...
    fn headless_use_card_service_moves_the_engraving() {
        ...
        game_state.apply_compatibility_action(
            crate::game_state::CompatibilityAction::UseCardService {
                card_service: MagicWandCardService.into_card_service(),
