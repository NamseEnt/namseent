...
// <<<<<<< HEAD
//                             SEQUENCE_ATOM.mutate(|sequence| sequence.update_cut(cut_id,  CutUpdateAction::GraphicFitContain {
//                                     graphic_index,
...
//                             SEQUENCE_ATOM.mutate(|sequence| sequence.update_cut(cut_id,  CutUpdateAction::GraphicFitCover {
//                                     graphic_index,
//                                     image_width_per_height_ratio,
//                                 },
//                             ));
