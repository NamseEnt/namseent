...
mod tests {
    ...
    #[test]
    #[wasm_bindgen_test]
    fn move_background_clip_backward_should_works() {
        // before : 0 1 2 3 4
    ...
    #[test]
    #[wasm_bindgen_test]
    fn move_background_clip_forward_should_works() {
        // before : 0 1 2 3 4
    ...
    #[test]
    #[wasm_bindgen_test]
    fn move_background_multiple_clips_backward_should_works() {
    ...
    #[test]
    #[wasm_bindgen_test]
    fn move_background_multiple_clips_forward_should_works() {
        // before : 0 1 2 3 4 5 6
