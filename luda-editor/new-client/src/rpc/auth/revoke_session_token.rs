...
pub fn revoke_session_token<'a, Deps, Artifacts>(
    ctx: &'a RenderCtx,
...
pub fn revoke_session_token_render<'a, Deps, Artifacts>(
    ctx: &'a RenderCtx,
    request: impl FnOnce(Deps) -> Option<(RefRequest<'a>, Artifacts)>,
    dependencies: Deps,
...
pub fn make_revoke_session_token_fn<'a, MakeRequestFn, ResponseFn, Artifacts>(
    ctx: &'a RenderCtx,
